...
define('SECRET_SALT','rEsYzw6drqDXp=AC7rRD2a39SI4Sb0LT');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','inour92@gmail.com');
...
define('DBNAME','webedhpo_crm');
define('DBUSER','webedhpo_crman');
define('DBPASS','PITUm6_Xv!0G');
